...
3. **签名并安装**：进入应用详情，点击“签名并安装”；签名完成后弹窗提示“签名完成，已发起安装”，可点“确定”留在详情页，或点“返回”关闭详情页并回到桌面首页。
